...
Существует и альтернативный подход: метод можно сделать абстрактным, то есть удалить его реализацию.
