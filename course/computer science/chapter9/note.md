...
**Рис. 4.11.** Диаграмма "**ящик с усами**" для суточных пиковых температур в Лос-Анджелесе в июле 2018 года ($n = 31$ день). На графике выбросы игнорируются.
...
**Рис. 4.12.** Диаграмма **"ящик с усами"** для суточных пиковых температур в Лос-Анджелесе за весь 2018 год ($n=365$). 
...
**Рис. 4.13.** Диаграммы "ящик с усами" для суточных пиковых температур в 2018 году в разных городах: Миннеаполис, Лос-Анджелес и Рио-де-Жанейро. 
...
На рисунках 4.14–4.16 показано, как изменение числа бинов изменяет внешний вид гистограммы, а также как можно использовать гистограммы для сравнения температурных данных разных городов.
...
**Рис. 4.14.** Построение гистограммы для суточных пиковых температур в Рио-де-Жанейро за 2018 год. 
...
**Рис. 4.15.** Шесть различных гистограмм, построенных на одном и том же наборе данных с разным количеством бинов. 
...
**Рис. 4.16.** Гистограммы пиковых температур для разных городов (Миннеаполис, Лос-Анджелес, Рио-де-Жанейро, 2018 год). 
...
**Рис. 4.17.** Построение кумулятивной гистограммы на основе обычной гистограммы для суточных пиковых температур в Рио-де-Жанейро. 
...
**Рис. 4.18.** Кумулятивные гистограммы пиковых температур для четырёх городов (Миннеаполис, Лос-Анджелес, Рио-де-Жанейро, и другие), построенные с 10 бинами. 
...
**Рис. 4.19.** Сравнение кумулятивных гистограмм пиковых температур в Миннеаполисе и Рио-де-Жанейро. 
...
[Pandas](https://pandas.pydata.org/) - библиотека для работы с данными на python
