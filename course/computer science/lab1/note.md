...
Программа шифрования/дешифрования файлов: учащиеся могут создать программу, которая шифрует и дешифрует файлы, используя различные алгоритмы шифрования, такие как шифр Цезаря, шифр Виженера или AES.
...
https://github.com/Winderton/xplatform