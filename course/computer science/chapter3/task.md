...
5. Получить показанный ниже вывод, в котором погрешность (стандартное отклонение) в значении каждой константы выражается как число в круглых скобках после предшествующих числовых разрядов, т. е. 6.67430(15)×10−11 означает 6.67430×10−11 ± 1.5×10−15.
