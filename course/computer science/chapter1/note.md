...
> Почему [арность](https://en.wikipedia.org/wiki/Arity) содержится в названии макроса. Я погуглила и выяснила, что это обходной путь (workaround) для решения [некоторых проблем безопасности](https://nvd.nist.gov/vuln/detail/CVE-2009-0029).
