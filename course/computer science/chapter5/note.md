...
- [[#Списки (List)|Списки (List)]]
	- [[#Списки (List)#Создание списка|Создание списка]]
	- [[#Списки (List)#Операции с списком|Операции с списком]]
	- [[#Списки (List)#Итерация списка и поиск|Итерация списка и поиск]]
	- [[#Списки (List)#Удаление списка|Удаление списка]]
	- [[#Списки (List)#Сортировка списка|Сортировка списка]]
	- [[#Списки (List)#Списки и математика|Списки и математика]]
- [[#Управление файлами|Управление файлами]]
	- [[#Управление файлами#Ввод и вывод файлов|Ввод и вывод файлов]]
	- [[#Управление файлами#Распространенные идиомы чтения данных файла|Распространенные идиомы чтения данных файла]]
	- [[#Управление файлами#Распространенные идиомы записи в файл|Распространенные идиомы записи в файл]]
- [[#Функции|Функции]]
	- [[#Функции#Пользовательские функции|Пользовательские функции]]
	- [[#Функции#Библиотечные функции|Библиотечные функции]]
	- [[#Функции#Ошибки и исключения|Ошибки и исключения]]
	- [[#Функции#Перехват и обработка исключений|Перехват и обработка исключений]]
	- [[#Функции#Вызов исключений|Вызов исключений]]
- [[#Контейнеры|Контейнеры]]
	- [[#Контейнеры#Обзор|Обзор]]
	- [[#Контейнеры#Списки как контейнер|Списки как контейнер]]
	- [[#Контейнеры#Построение списка|Построение списка]]
	- [[#Контейнеры#Словари как контейнер|Словари как контейнер]]
	- [[#Контейнеры#Создание словарей|Создание словарей]]
	- [[#Контейнеры#Поиск по словарю|Поиск по словарю]]
	- [[#Контейнеры#Составные ключи|Составные ключи]]
	- [[#Контейнеры#Наборы|Наборы]]
- [[#Форматирование|Форматирование]]
	- [[#Форматирование#Форматирование строк|Форматирование строк]]
	- [[#Форматирование#Коды форматирования|Коды форматирования]]
	- [[#Форматирование#Форматирование словаря|Форматирование словаря]]
	- [[#Форматирование#Метод `format()`|Метод `format()`]]
	- [[#Форматирование#Форматирование в стиле C|Форматирование в стиле C]]
- [[#Последовательности|Последовательности]]
	- [[#Последовательности#Типы данных последовательности|Типы данных последовательности]]
	- [[#Последовательности#Нарезка|Нарезка]]
	- [[#Последовательности#Переназначение фрагмента|Переназначение фрагмента]]
	- [[#Последовательности#Сокращение последовательности|Сокращение последовательности]]
	- [[#Последовательности#Итерация по последовательности|Итерация по последовательности]]
	- [[#Последовательности#оператор разрыва|оператор разрыва]]
	- [[#Последовательности#Оператор продолжения|Оператор продолжения]]
	- [[#Последовательности#Цикл по целым числам|Цикл по целым числам]]
	- [[#Последовательности#функция перечисления|функция перечисления]]
	- [[#Последовательности#Циклы и кортежей|Циклы и кортежей]]
	- [[#Последовательности#функция zip()|функция zip()]]
- [[#Взаимодействие со списками|Взаимодействие со списками]]
	- [[#Взаимодействие со списками#Создание новых списков|Создание новых списков]]
	- [[#Взаимодействие со списками#Фильтрация|Фильтрация]]
	- [[#Взаимодействие со списками#Случаи использования|Случаи использования]]
	- [[#Взаимодействие со списками#Общий синтаксис|Общий синтаксис]]
	- [[#Взаимодействие со списками#Исторический экскурс|Исторический экскурс]]
- [[#Объекты|Объекты]]
	- [[#Объекты#Assignment|Assignment]]
	- [[#Объекты#Пример назначения|Пример назначения]]
	- [[#Объекты#Переназначение значений|Переназначение значений]]
	- [[#Объекты#Идентификация и ссылки|Идентификация и ссылки]]
	- [[#Объекты#Мелкие копии|Мелкие копии]]
	- [[#Объекты#Глубокие копии|Глубокие копии]]
	- [[#Объекты#Имена, значения, типы|Имена, значения, типы]]
	- [[#Объекты#Проверка типа|Проверка типа]]
- [[#Все является объектом|Все является объектом]]
